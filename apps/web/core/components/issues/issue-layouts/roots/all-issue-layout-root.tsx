...
export const AllIssueLayoutRoot = observer(function AllIssueLayoutRoot(props: Props) {
  ...
  // On phones the Table (Spreadsheet) overflows / doesn't render well, so fall back to the
  // cross-project List layout (which is mobile-friendly) — Board renders natively on mobile.
